...
def _set_visible_form(window: MainWindow) -> None:
    ...
    window._sb_n_points.setValue(160)
...
def _populate_real_results(window: MainWindow) -> None:
    ...
    # Reuse the first UI-created entry, then append the remaining two.
